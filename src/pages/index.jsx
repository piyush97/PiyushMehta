    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="MEAWW INFLUENCER DASHBOARD"
              link="https://meaww.com"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              Meaww Influencer Dashboard(React) Made a Dashboard Using: React, Redux, RESTful APIs, Material - UI
            </ProjectCard>
            <ProjectCard
              title="GitApp"
              link="https://whispering-island-83455.herokuapp.com/"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              GitHub Repository Scraper Using React, Elastic Search, Redux and Open Source Datasets and Tachyons
            </ProjectCard>
            <ProjectCard
              title="DashCrypt"
              link="https://github.com/piyush97/dashcrypt"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              DashCrypt: Crypto Currency DashBoard Using D3js and React
            </ProjectCard>
            <ProjectCard
              title="CrypTrack"
              link="https://github.com/piyush97/cryptrack"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              CryptoCurrency App Finds Market Cap for CryptoCurrency using React Native
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Piyush Mehta" />
            <AboutSub>
              I am in my Pre - Final year of Information Science Engineering and I have a keen interest in web development.
              I'm a self-taught Web Developer and I work on Full Stack. Spending most of my time converting my ideas into code.
              I enjoy learning design patterns from people's code. Besides work, I love to capture the sweetest moments of my life in 16:9 camera roll.
            </AboutSub>
          </AboutHero>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:me@piyushmehta.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://github.com/piyush97">GitHub</a> &{' '}
            <a href="https://www.linkedin.com/in/piyush24">Linkedin</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 by Piyush Mehta <a href="https://github.com/piyush97/PiyushMehta">Github Repository</a>
        </Footer>
      </Content>
